...
description: Deep codebase discovery using MCP and text tools. Use this to bridge the gap between raw MCP tool data and high-level architectural understanding. In ISFS workspaces, use iris_search to find references across server-side classes and iris_read_compiled to inspect macro-expanded intermediate code.
---
